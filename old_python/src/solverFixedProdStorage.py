...
def solve_fixed_prod_storage(
    ...
    - construction_cost : Construction cost (€) # In this version, could be computed before optimization
    """
    # Create the model
